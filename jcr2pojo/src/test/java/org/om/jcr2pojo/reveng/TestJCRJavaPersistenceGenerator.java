   ...
   public void testAllFiles() {
      try {
         ...
         for (int i = 0; i < files.length; i++) {
             ...
             * go for it
             */
            final JCRJavaPersistenceGenerator engine = new JCRJavaPersistenceGenerator(rootNode, "com.khubla.revenge.test", "target/reveng/" + testname, new NodeNameClassNamingStrategy(),
